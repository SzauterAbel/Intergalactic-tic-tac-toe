...
class GameLogic:
    ...
    def get_valid_moves(self):
        ...
        for b9x9_row, b9x9_col in active_blocks_9x9:
            ...
            if self.active_9x9_block == (b9x9_row, b9x9_col) and self.active_3x3_block is not None:
    ...
    def make_move(self, row, col):
        ...
        if block_9x9_row < 3 and block_9x9_col < 3:
            if self.blocks_9x9[block_9x9_row][block_9x9_col] == '':
                ...
                if self.active_3x3_block is not None:
                    ...
                    if block_3x3_row_local != required_3x3_row or block_3x3_col_local != required_3x3_col:
                        return False
        ...
        local_row = row % 3
        local_col = col % 3
        self.blocks_state_3x3[block_3x3_row_global][block_3x3_col_global][local_row][local_col] = self.current_player
        
        # Check if this move wins a 3x3 block
        block_won = self._check_block_3x3_win(block_3x3_row_global, block_3x3_col_global)
        if block_won:
            self.blocks_3x3[block_3x3_row_global][block_3x3_col_global] = self.current_player
            
            # Update the 9x9 block's state
            self.blocks_state_9x9[block_9x9_row][block_9x9_col][block_3x3_row_local][block_3x3_col_local] = self.current_player
